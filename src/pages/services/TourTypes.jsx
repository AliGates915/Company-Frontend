...
function SubHead() {
    ...
    const handleHeadTypeSelect = (headName) => {
        ...
        if (selectedHead) {
            ...
            setHeadCode(selectedHead.code); // Set the head code based on selection
            setSubHeadCode(`${selectedHead.code}${String(sequenceNumber).padStart(2, '0')}`); // Generate initial subhead code based on head
        } else {
